  ...
  <div class="my-cv wrapper">
    <header class="my-cv__header">
      ...
      <div class="my-cv__photo">
        <div class="my-cv__photo-googles">
          <svg class="my-cv__googles-svg" fill="#00003fdf" version="1.1" id="Layer_1" xmlns:x="&ns_extend;" xmlns:i="&ns_ai;" xmlns:graph="&ns_graphs;"
...
<switch>
	...
	<g i:extraneous="self">
		<path d="M727.6,348.1c-2.8-29.9-14.9-57.6-38.1-77.2c-24.7-20.9-62.4-30.6-94.1-32.4c-35.6-2-71.8,1-107.6,0.3
			...
			c14.4,0,28.8-0.2,43.2-0.5C473.5,246,474.1,246.5,473.7,247.1z"/>
	</g>
</switch>
  </svg>
        </div>
...
const currentCv = computed(() => myCv[currentLanguage.value])
</script>
