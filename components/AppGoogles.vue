<template>
  <div
    ref="photoGooglesEl"
    class="app-googles__photo-googles"
    draggable="true"
  ...
  >
    <svg
      ...
      :class="[darkMode ? 'night-glasses' : 'sun-glasses']"
      color="currentColor"
      fill="#00003fdf"
      version="1.1"
      id="Layer_1"
    ...
    >
      <switch>
        ...
        <g i:extraneous="self">
          <path
            d="M727.6,348.1c-2.8-29.9-14.9-57.6-38.1-77.2c-24.7-20.9-62.4-30.6-94.1-32.4c-35.6-2-71.8,1-107.6,0.3
...
const mobileGooglesEl = ref()
const shiftX = ref(0);
const shiftY = ref(0);
const mobileShiftX = ref(0);
const mobileShiftY = ref(0);
